...
local function enterOwnedHouse(house)
    ...
    Wait(250)
    TriggerEvent('qb-weathersync:client:setWeather', 'EXTRASUNNY')
    TriggerEvent('qb-weathersync:client:toggleDynamicWeather', false)
    TriggerEvent('qb-weathersync:client:setTime', 24, 00)
    TriggerEvent('qb-weathersync:client:toggleFreezeTime', true)
    -- TriggerEvent('qb-weathersync:client:EnableSync')
